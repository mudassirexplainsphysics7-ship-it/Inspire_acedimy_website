            ...
            <div className="container mx-auto px-4 md:px-6 py-12 lg:py-20">
                ...
                <div className="text-center max-w-4xl mx-auto mb-20">
                    ...
                    <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
                        Inspire Academy is <span className="text-primary-600">Your Trusted Academy & Home/Online Tuition Provider</span>. We provide quality education for class 1 to 12 focused on concept clarity, critical thinking, exam preparation, and overall academic excellence.
                    </p>
                </div>
